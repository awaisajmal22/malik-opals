...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  List<Widget> views = [
    ...
    ImageGalleryScreen(),
    UpdateProfile(isProfileUpdate: false,isBankDetailUpdate: false,),
    UpdateBankDetails(
  ...
  void initState() {
    ...
    SessionData().getUserProfile().then((value) {
      ...
      if (isRefrenceAllowed) {
        ...
        grid_menu_icons.insert(10, 'assets/svg/ref_in.png');
      ...
      if (IsSubReferenceAllowed) {
        ...
        grid_menu_icons.insert(11, 'assets/svg/subRefenceIn.png');
