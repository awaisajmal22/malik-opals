                ...
                Icon: Center(
                  child: SvgPicture.asset(
                    currentScreen.value == screen.home
                        ...
                        color:currentScreen.value == screen.home? Color(0xff1164AA): null,
                  ),
                ),
                text: "Home"),
          ),
                ...
                Icon: Center(
                  child: SvgPicture.asset(
                      ...
                      currentScreen.value == screen.dashboard
                          ...
                          : "assets/newassets/dashBordUnselected.svg",color: currentScreen.value == screen.dashboard? Color(0xff1164AA): null,),
                ),
                text: "Dashboard"),
          ),
          GestureDetector(
                    ...
                    children: [
                      ...
                      FittedBox(
                          child: CircleAvatar(
                              ...
                              radius: 45.h,
                              child: Image.asset('assets/images/opallogo.png'),
                              // Image.asset(
          ...
          SizedBox(
            ...
            child: Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .bodyText1!
                  .copyWith(overflow: TextOverflow.visible, height: 1.3,fontSize: 13.sp),
              maxLines: 2,
              softWrap: true,
              textAlign: TextAlign.center,
            ),
