    ...
    final password = GestureDetector(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            icon: Padding(
              padding: EdgeInsets.only(
                  left: isTablet() ? size.width * 0.1.w : _passwordtextcontroller.text.length > 8 ? size.width * 0.05 : size.width * 0.2.w),
              child:_passwordtextcontroller.text.length > 8 ? SizedBox.shrink() : Container(
                height: 24.h,
                width: 24.w,
                child: SvgPicture.asset(
